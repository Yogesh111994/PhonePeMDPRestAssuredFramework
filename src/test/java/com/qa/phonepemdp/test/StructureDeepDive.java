...
public class StructureDeepDive extends BaseTest{
	...
	public Object[][] reporteeData() {
		return new Object[][] {
			{"Ambr3244","Ambr3244@phonepe.com","Product Director - Merchant Payments","Q1 2024: Jan - Feb - Mar","2024","Direct"},
			{"Harj2232","Harj2232@phonepe.com","Associate Director - Product Management","Q4 2023: Oct - Nov - Dec","2023","Direct"}
		};
	}
	...
	public void getStructureDeepDiveTest(String name,String email,String role,String quarter,String year,String spanText) {
		...
		Timeline   timeline= new Timeline(quarter,true,year);
		...
		.when().log().all()
		.post("/ui/apis/getDeepDiveStructure")
		.then().log().all()
		.assertThat()
		.statusCode(200);
